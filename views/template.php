...
<div class="<?php echo $css_class_prefix; ?>row" id="<?php echo $keyword_css_id; ?>">
  ...
  <div class="<?php echo $css_class_prefix; ?>column">
    ...
    <a class="<?php echo $css_class_prefix; ?>action" href="#" onclick="if (confirm('<?php echo __('Delete current metadata?'); ?>')) { page_metadata_remove('<?php echo $keyword_css_id; ?>', '<?php echo $keyword; ?>'); }; return false;" title="<?php echo __('Remove Metadata'); ?>"><img src="<?php echo URI_PUBLIC;?>admin/images/minus.png" alt="minus icon" /></a>
  </div>
</div>